...
sub new
{
    ...
    {
        $logger->error("Detection Parameters not defined. Can't continue");
        return undef;
    }
...
sub detection()
{
    ...
    my ($self, $srcHost, $dstHost, $timeseries, $sessionMinDelay) = @_;
    ...
    # TODO temporarily disable this function

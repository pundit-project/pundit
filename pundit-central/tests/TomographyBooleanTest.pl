...
use PuNDIT::Central::Localization::Tomography::Boolean;
use PuNDIT::Utils::TrHop;

=pod
TomographyBooleanTest.pl

Test cases for Boolean Tomography
=cut
...
my $tomo = new PuNDIT::Central::Localization::Tomography::Boolean(\%cfgHash, "federation1");
...
sub run_test_case_0
{
    ...
    print Dumper $tomo->runTomo(\@event_table, $trMatrix, $trNodePath, $path_set, $link_set);
}
